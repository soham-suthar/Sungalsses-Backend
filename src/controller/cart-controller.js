...
const addToCart = asyncMiddleware(async (req, res) => {
...
const updateQuantity = asyncMiddleware(async (req, res) => {
  const userId = req.user._id;
...
const removeFromCart = asyncMiddleware(async (req, res) => {
  const cart = await Cart.findOne({ user: req.user._id });
...
const clearCart = asyncMiddleware(async (req, res) => {
  const cart = await Cart.findOne({ user: req.user._id });
